...
async function fetchAnalysis(home, away, leagueName, lcc) {
  const prompt = `Analisis: ${home} vs ${away} (${leagueName}). LCC=${lcc}.
Balas JSON saja (tanpa teks lain, tanpa markdown):
{"hF":"WWDLW","aF":"LWDWL","hR":2,"aR":5,"hP":58,"aP":42,"h2h":"Home menang 2 dari 3","inj":"Tidak ada","ctx":"Kandang butuh poin","swp":72,"fr":81,"ff":${Math.round(75*lcc)},"v":"CONFIRMED","o25":68,"stk":"2u","sum":"Ringkasan singkat 1 kalimat"}`;
  ...
  if (!result) throw new Error("Parse gagal, coba lagi");
